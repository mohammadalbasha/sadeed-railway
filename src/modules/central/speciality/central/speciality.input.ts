...
@InputType()
export class SpecialityLocaleInput extends BaseLocaleItemInput {
    @MinLength(2)
    name!: string;
...
@InputType()
export class CreateSpecialityInput extends BaseHasLocaleInput(SpecialityLocaleInput) {
  @IsOptional()
...
@InputType()
export class UpdateSpecialityInput extends BaseUpdateInput(CreateSpecialityInput){}


@InputType()
export class SpecialityOrderInput extends BaseOrderInput(['countries']) {}
